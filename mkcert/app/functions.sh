...
function get_docker_gen_container {
    ...
    local docker_gen_cid="$(labeled_cid com.github.elasticlabs.ensg-2022-tutorials.ensg-local-https-proxy.docker_gen)"
...
function get_nginx_proxy_container {
    ...
    local nginx_cid="$(labeled_cid com.github.elasticlabs.ensg-2022-tutorials.ensg-local-https-proxy.nginx_proxy)"
